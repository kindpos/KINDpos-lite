...
var PIZZA_TOPPINGS = {
  ...
  options: [
    ...
    // Specials (yellow border) — each includes a preset bundle of toppings
    { id: 'bianco', label: 'Bianco', price: 0, special: true,
      includes: ['Mozzarella', 'Ricotta', 'Garlic', 'Spinach'] },
    { id: 'breakfast-bacon', label: 'Breakfast Bacon', price: 0, special: true,
      includes: ['Bacon', 'Eggs', 'Mozzarella'] },
    { id: 'cheeseburger', label: 'Cheeseburger', price: 0, special: true,
      includes: ['Ground Beef', 'Cheddar', 'Onion', 'Pickles', 'Ketchup'] },
    { id: 'chicken-alfredo', label: 'Chicken Alfredo', price: 0, special: true,
      includes: ['Chicken', 'Mozzarella', 'Alfredo Sauce'] },
    { id: 'crew', label: 'Crew', price: 0, special: true,
      includes: ['Pepperoni', 'Sausage', 'Mushroom', 'Onion', 'Green Peppers'] },
    { id: 'hawaiian', label: 'Hawaiian', price: 0, special: true,
      includes: ['Ham', 'Pineapple', 'Mozzarella'] },
    { id: 'house', label: 'House', price: 0, special: true,
      includes: ['Pepperoni', 'Sausage', 'Onion', 'Green Peppers', 'Mushroom', 'Black Olives'] },
    { id: 'kosher', label: 'Kosher', price: 0, special: true,
      includes: ['Mozzarella', 'Onion', 'Green Peppers', 'Mushroom', 'Black Olives'] },
    { id: 'mac-n-cheese', label: 'Mac N Cheese', price: 0, special: true,
      includes: ['Macaroni', 'Cheddar', 'Mozzarella'] },
    { id: 'moccho', label: 'Moccho', price: 0, special: true,
      includes: ['Mozzarella', 'Ricotta', 'Pepperoni'] },
    { id: 'nick-special', label: 'Nick Special', price: 0, special: true,
      includes: ['Pepperoni', 'Sausage', 'Meatball', 'Onion', 'Mozzarella'] },
    { id: 'primo', label: 'Primo', price: 0, special: true,
      includes: ['Pepperoni', 'Sausage', 'Ham', 'Bacon', 'Mozzarella'] },
    { id: 'sammys-special', label: "Sammy's Special", price: 0, special: true,
      includes: ['Chicken', 'Spinach', 'Tomato', 'Garlic', 'Mozzarella'] },
    { id: 'taco', label: 'Taco', price: 0, special: true,
      includes: ['Ground Beef', 'Cheddar', 'Lettuce', 'Tomato', 'Taco Sauce'] },
    { id: 'veggie', label: 'Veggie', price: 0, special: true,
      includes: ['Mushroom', 'Onion', 'Green Peppers', 'Black Olives', 'Tomato', 'Spinach'] },
  ],
};
